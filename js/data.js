const data = [
  ...
  },
  {
    ...
    groups: ['Горячее', 'Белок', 'Прочее'],
    needs: ['100 гр. муки', '1 яйцо', "50 мл. молока", "150 гр. сыра", "1 ст.л. сахара"],
    steps: ['Взбить яйцо с сахаром  и мукой', 'Натереть сыр и добавить его в тесто', 'Добавить молоко для лучшего перемешивания и хорошо перемешать',
      "Выложить на сухую сковороды и разровнять вилкой или ложкой (сыр даст жир для жарки, когда нагреется)", "Жарить до золотистой корочки, перевернуть и пожарить снова"],
    comments: 'Рассчет на 1 порцию'
  },
  {
    id: 23,
    title: "Масурдал",
  ...
  },
  {
    ...
    steps: ['Ставим воду, солим ее, промываем крупу', 'Когда вода закипит, насыпаем крупу', 'Пробуем для определения готовности'],
    comments: ''
  },
  {
    id: 25,
  ...
  },
  {
    ...
    needs: ['1 ст. манной крупы', '1.5 ст. молока', "1.5 ст. воды", "3 ст.л. сахара"],
    steps: ['Ополаскиваем кастрюлю холодной водой, чтобы молоко не прикипало. Наливаем воду, молоко, добавляем сахар', 'Когда почти начнет кипеть', 'Кушать'],
    comments: ''
  },
  {
    id: 27,
