...
"8. За пять минут до готовности риса втыкаем в разные места очищенные и разрезанные надвое зубчики чеснока"],
    ...
    },
    {
        ...
        needs: ['3 яйца', '1 ст. муки', "1 ст. горячей муки", "Молоко", "Сахар", "Масло для жарки"],
        steps: ['1. Взбить яйца с сахаром и молоком', '2. Влить 1/2 сткана воды, взбить', '3. Продолжая взбивать, всыпать муку и долить воду + немного масла',
    "4. Выливать примерно по половине половника (зависит от размера сковорды) на сквороду, чтоб хорошо переворачивались", "5. Обжарить с двух сторон"],
        comments: ''
    },
    {
        id: 8,
