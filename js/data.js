const data = [
  ...
  {
      id: 47,
      title: 'Овсяная каша с сыром',
      groups: ['Белок', 'Горячее', 'Молочное', 'Каши'],
      needs: ['100 гр. овсянки', '100 мл. воды', '100 мл. молока', '50 гр. сыра', '5 гр. сливочного масла', 'соль\сахар по вкусу'],
      steps: [
        'Промыть овсянку, залить водой и молоком. Дождаться закипания и варить, сколько указано для крупы.',
        'Натереть сыр на крупной терке',
        'По готовности добавить в кашу сливочное масло и натертый сыр, хорошо перемешать.',
      ],
      comments: ''
  },
{
    id: 48,
    title: 'Походная каша с сайрой',
    groups: ['Белок', 'Овощи', 'Горячее', 'Рыба', 'Каши'],
    needs: [
      '1 банка консервированной сайры',
      '3 больших картофелины или сколько найдется',
      '1 большая морковь или сколько найдется',
      '1 стакан риса',
      'Соль и перец по вкусу',
      'Пучок укропа'
    ],
    steps: [
      'Промыть и начать варить рис',
      'Пока рис вариться, очистить и нарезать картошку и морковь',
      'Когда рис будет наполовину готов, добавить к нему овощи',
      'За несколько минут до готовности добавить сайру, соль, перец и укроп',
    ],
    comments: 'Рецепт нуждается в уточнении порядка варки ингредиентов'
}
]
// {
//     id: 1,
//     title: '',
//     groups: ['Белок', 'Овощи', 'Горячее', 'Молочное', 'Сладкое', 'Салаты', 'Рыба', 'Каши', 'Прочее'],
//     needs: ['', '',],
//     steps: ['', '', '',],
//     comments: ''
// }
