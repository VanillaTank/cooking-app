const data = [
  ...
  },
  {
    ...
    steps: ['1. Взбить яйца с молоком, сахаром и ванильным сахаром', '2. Взбивая, всыпать муку и влить горячую воду', '3. Влить в тесто немного масла для жарки',
      "4. На разогретую блинную сковородку наливаем 1 раз масло для жарки", "5. Наливаем почти полный (зависит размеров) половник теста на сковородку и бастро распределяем",
      "6. Переворачиваем, когда подрумянятся края блинчика"],
    comments: ''
  },
  {
    id: 8,
    ...
    steps: ['1. Режем лук полу-кольцами, кладем в ПЛАСТИКОВУЮ (металл может окислиться) емкость. Давим руками или ложкой, чтоб вышел сок, заливаем миналкой так, чтобы покрыть лук',
      '2. Режем филе кубиками примерно 3х3см', '3. Доваляем к луку, туда же сыпем соль и перец, добавляем кетчуп', "4. Заливаем минералкой, чтобы покрыло все филе и оставляем под прессом в холодильнике на 40 минут"],
    comments: ''
  },
  {
    id: 9,
    ...
    steps: ['1. Жарим пельмени на сковороде до образования корочки', '2. Заливаем молоком и тушим несколько минут'],
    comments: ''
  },
  {
    id: 10,
    ...
    steps: ['1. Отделить белки от желтков.', '2. Взбить белки до образования устойчевых пиков', '3. Желтки перемешать с творогом, сахаром, специями и мукой',
      "4. Добавить к творгу взбитые белки и ягоду", "5. Смазать форму маслом, выложить смесь, поставить в предварительно разогретую духовку на 25 минут",
      "6. Готовность - запеканка твердая и румяная сверху"],
    comments: ''
  },
  {
    id: 11,
    ...
    steps: ['1. Взбить яйца с йогуртом, мукой и измельченным укропом', '2. Вылить на сковороду, посыпать тертым сыром', '3. Запекать под крышкой',
      "5. Когда поверхность начнет схватываться, украсить кружочками помидора и разрезанными оливками"],
    comments: ''
  },
  {
    id: 12,
    ...
    steps: ['1. Разогреть сковороду без масла', '2. Положить пластк сыра и накрыть его хлебом', '3. Поправлять растекующийся сыр, налепляя его на края хлеба'],
  ...
  },
  {
    ...
    steps: ['1. На холодной сковороде смешать оливковое масло, чеснок, базилик и варить на слабом огне, иногда помешивая', '2. Добавить нарезанные кубиками помидоры, довести до кипения',
      '3. Варить примерно 10 минут, помешивая, на слабом огне', "4. Разбить в сковородку яйца и подождать, пока они стабилизируются"],
    comments: ''
  },
  {
    id: 14,
    ...
    steps: ['1. Сврить рис до полуготовности', '2. Порезать батат кубиками, добавить к рису, перемешать', '3. Через пару минут добавить нут, перемешать',
  "4. За пару минут до готовности влить соевый соус и насыпать порезанную петрешку, перемешать", "5. Дать настояться 20 минут"],
    comments: ''
  },
   {
      id: 15,
      ...
      steps: ['1. Промыть и замочить чернослив', '2. Обжарить курицу, залить водой и оставить тушиться. Посолить', '3. Через 5 минут добавить порезанный на четверти чернослив',
    "4. Когда курица будет готова, залить сметаной и перемешать. Оставить тушиться в сметане на 3 минуты"],
      comments: ''
  }
  // {
  //     id: 1,
