const data = [
  ...
  },
  {
    ...
    title: "Шакшука",
    groups: ['Горячее', 'Белок', 'Овощи'],
    needs: ["6 яиц", '700 гр. помидоров', '1 горсть свежих листьев базилика', "2 ст.л. оливкового масла", "6 зубчиков чеснока", "1/2 ч.л. черного и красного перцев"],
  ...
  },
  {
    ...
    needs: ['куринное филе', ' стручковая фасоль', "помидоры черри", "болгарский перец", "чеснок", "соевый соус", "Масло для жарки"],
